...
- See [[RESPONSIBLE_USE]] for the project-level responsible use statement.
...
- External skills must be registered in [[ExternalSkills/External-Skill-Index|External Skills]] before they are treated as trusted workflow guidance.
...
1. Read [[Nexus|Nexus]].
2. Read [[State/Current-Snapshot|Current Snapshot]].
3. Find the relevant task in [[Tasks/Task-Index|Tasks]].
4. Find the relevant workspace in [[Workspaces/Workspace-Index|Workspaces]].
